...
ID: 199903002012
Content:
Given that $$-3 \leq x \leq 2$$ and $$-7 \leq y \leq 3$$, find;;a) The largest possible value of x-y, [1];;b) The smallest possible value of $$x^2$$, [1];;c) The value of y if $$y^2 = 36$$. [1]Answers:

ID: 199903002015
Content:
a) Simplify;;a-i) $$n^2 - (n - 2)(n + 2)$$, [1];;a-ii) $$n^2 - (n - a)(n + a)$$. [1];;b) Using your answer to part (1)(ii), write down the value of $$16947^2 - 16944 \times 16950$$ Answers:

ID: 199903002017
Content:
a) The surface area of a solid cone is given by the formula $$A = \pi r^2 + \pi rl$$;;a-i) Factorise fully the expression $$pi r^2 + \pi rl$$. [1];;a-ii) Rearrange the formula to express l in terms of $$\pi$$, r and A. [1];;b) $5 is to be divided between Alan and Brenda in the ratio x: 2. Write down an expression, in terms of x, for Alan's shareAnswers:
...
ID: 200101002003
Content:
a) Write down all the integer values of n for which $$-2\leq n<4$$. [1];;b) Find the least integer value of x for which 3 - x < 2. [1]Answers:

ID: 200101002008
Content:
A solution of the equation $$x^{2} +kx+9=0$$ is x = 3. Find the value of k. [2]Answers:

ID: 200101002010
Content:
Solve the equations;;a) $$\frac{5}{x}=8$$, [1];;b) 7y - 4(y + 5) = 1. [2]Answers:

ID: 200101002020
Content:
a) Calculate the value of $$n^{3} -n$$ when;;a-i) n = 4, [1];;a-ii) n = -2. [1];;b) Factorize completely $$n^{3} -n$$. [2];;c) Give a reason why $$n^{3} -n$$ is divisible by 2 for any integer value of n. [1]Answers:
...
ID: 200202002002
Content:
a) Remove the brackets and simplify (q + 3r)(2q - r). [2];;b) Given that m = -2 and n = 4, evaluate;;b-i) $$5 m^{3} $$, [1];;b-ii) $$\frac{m}{n}+\frac{n}{m}$$;;c) Factorize completely $$3y^{2} -3$$. [2];;d) Peter has $20 and Paul has $212. When they are each given $x, Paul has 5 times as much as Peter. Write down an equation in x and solve it. [3]Answers:
...
ID: 200503002015
Content:
a) Solve the equation $$(2a-3)^{2} =16$$. [2];;b) y is directly proportional to $$x^{2} $$. X is increased by 100%. Find the percentage increase in y. [2]Answers:
