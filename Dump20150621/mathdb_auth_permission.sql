...
CREATE TABLE `auth_permission` (
  ...
  CONSTRAINT `auth__content_type_id_6e12a0668de28c7a_fk_django_content_type_id` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`)
