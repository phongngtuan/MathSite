...
LOCK TABLES `answertype` WRITE;
/*!40000 ALTER TABLE `answertype` DISABLE KEYS */;
INSERT INTO `answertype` VALUES (1,'Prove'),(2,'Sketch'),(3,'Numeric'),(4,'Expression'),(5,'Text');
/*!40000 ALTER TABLE `answertype` ENABLE KEYS */;
UNLOCK TABLES;
